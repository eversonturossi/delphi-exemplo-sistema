    ...
    begin
        if (Trim(EditNovaSenha.Text) <> Trim(EditConfirmaSenha.Text)) then
          ...
          begin
            ...
            BancoDeDados.ProcScripts.Script.Text := 'update cadusuario set senha = '+QuotedStr(Base64EncodeStr(EditNovaSenha.Text))+
                ' where idusuario = '+IntToStr(BancoDeDados.qryCadUsuarioidusuario.Value)+';';
