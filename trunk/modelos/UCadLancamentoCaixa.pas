...
type
  TCadLancamentoCaixaForm = class(TForm)
...
var
  CadLancamentoCaixaForm: TCadLancamentoCaixaForm;
  GrupoID : Integer;
implementation
uses Base, UFuncoes;
{$R *.dfm}

procedure TCadLancamentoCaixaForm.BTAlterarClick(Sender: TObject);
begin
  AbaSuperior.ActivePage := tsManutencao;
  DBEditNome.SetFocus;
end;

procedure TCadLancamentoCaixaForm.BTCancelarClick(Sender: TObject);
begin
...
procedure TCadLancamentoCaixaForm.BTExcluirClick(Sender: TObject);
begin
  try
...
procedure TCadLancamentoCaixaForm.BTGravarClick(Sender: TObject);
begin
  BancoDeDados.qryCadGrupo.ApplyUpdates;
  AbaSuperior.ActivePage := tsConsulta;
end;

procedure TCadLancamentoCaixaForm.BTInserirClick(Sender: TObject);
begin
...
procedure TCadLancamentoCaixaForm.BTPesquisarClick(Sender: TObject);
var
  Campo : ShortString;
begin
...
procedure TCadLancamentoCaixaForm.BTSairClick(Sender: TObject);
begin
  Close;
end;

procedure TCadLancamentoCaixaForm.CBPesquisarChange(Sender: TObject);
begin
  EditPesquisar.Clear;
  EditPesquisar.SetFocus;
end;

procedure TCadLancamentoCaixaForm.DBGrid1DblClick(Sender: TObject);
begin
  BTAlterarClick(Self);
end;

procedure TCadLancamentoCaixaForm.EditPesquisarChange(Sender: TObject);
begin
  BTPesquisarClick(Self);
end;

procedure TCadLancamentoCaixaForm.FormCreate(Sender: TObject);
begin
  AbaSuperior.ActivePage := tsConsulta;
  CHApenasAtivos.Checked := True;
end;

procedure TCadLancamentoCaixaForm.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if (key = #13) then
    begin
      Key := #0;
...
procedure TCadLancamentoCaixaForm.tsConsultaShow(Sender: TObject);
begin
  BTPesquisarClick(Self);
  EditPesquisar.SetFocus;
end;

procedure TCadLancamentoCaixaForm.tsManutencaoShow(Sender: TObject);
begin
