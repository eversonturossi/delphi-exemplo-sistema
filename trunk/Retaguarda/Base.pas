...
type
  TBancoDeDados = class(TDataModule)
    ...
    qryCsVendedor: TZReadOnlyQuery;
    qryCadVendedor: TZQuery;
    DSqryCsVendedor: TDataSource;
    DSqryCadVendedor: TDataSource;
    qryCsVendedoridvendedor: TIntegerField;
    qryCsVendedorativo: TBooleanField;
    qryCsVendedortipo: TSmallintField;
    qryCsVendedoridusuario: TIntegerField;
    qryCsVendedornome: TStringField;
    qryCsVendedorlogin: TStringField;
    qryCsVendedorsenha: TStringField;
    qryCsVendedordata_cadastro: TDateField;
    qryCsVendedorcalc_nome_usuario: TStringField;
    qryCadVendedoridvendedor: TIntegerField;
    qryCadVendedorativo: TBooleanField;
    qryCadVendedortipo: TSmallintField;
    qryCadVendedoridusuario: TIntegerField;
    qryCadVendedornome: TStringField;
    qryCadVendedorlogin: TStringField;
    qryCadVendedorsenha: TStringField;
    qryCadVendedordata_cadastro: TDateField;
    qryCadVendedorcalc_nome_usuario: TStringField;
    qryCsFormaPagamento: TZReadOnlyQuery;
    qryCadFormaPagamento: TZQuery;
    DSqryCsFormaPagamento: TDataSource;
    DSqryCadFormaPagamento: TDataSource;
    qryCsFormaPagamentoidforma_pagamento: TIntegerField;
    qryCsFormaPagamentoativo: TBooleanField;
    qryCsFormaPagamentodata_cadastro: TDateField;
    qryCsFormaPagamentodescricao: TStringField;
    qryCadFormaPagamentoidforma_pagamento: TIntegerField;
    qryCadFormaPagamentoativo: TBooleanField;
    qryCadFormaPagamentodata_cadastro: TDateField;
    qryCadFormaPagamentodescricao: TStringField;
    qryCsVendedorFormaPagamento: TZReadOnlyQuery;
    DSqryCsVendedorFormaPagamento: TDataSource;
    qryCsVendedorFormaPagamentoidformapagamento_vendedor: TIntegerField;
    qryCsVendedorFormaPagamentoidforma_pagamento: TIntegerField;
    qryCsVendedorFormaPagamentoidvendedor: TIntegerField;
    qryCsVendedorFormaPagamentodata_cadastro: TDateField;
    qryCsVendedorFormaPagamentocalc_nome_forma_pagamento: TStringField;
    qryCsTipoDocumento: TZReadOnlyQuery;
    qryCadTipoDocumento: TZQuery;
    DSqryCsTipoDocumento: TDataSource;
    DSqryCadTipoDocumento: TDataSource;
    qryCsTipoDocumentoidtipo_documento: TIntegerField;
    qryCsTipoDocumentoativo: TBooleanField;
    qryCsTipoDocumentodata_cadastro: TDateField;
    qryCsTipoDocumentodescricao: TStringField;
    qryCadTipoDocumentoidtipo_documento: TIntegerField;
    qryCadTipoDocumentoativo: TBooleanField;
    qryCadTipoDocumentodata_cadastro: TDateField;
    qryCadTipoDocumentodescricao: TStringField;
    qryCsMovimentoCaixa: TZReadOnlyQuery;
    qryCadMovimentoCaixa: TZQuery;
    DSqryCsMovimentoCaixa: TDataSource;
    DSqryCadMovimentoCaixa: TDataSource;
    qryCsMovimentoCaixaidmovimento_caixa: TIntegerField;
    qryCsMovimentoCaixacancelado: TBooleanField;
    qryCsMovimentoCaixadata_lancamento: TDateTimeField;
    qryCsMovimentoCaixatipo: TSmallintField;
    qryCsMovimentoCaixahistorico: TStringField;
    qryCsMovimentoCaixaidconta_origem: TIntegerField;
    qryCsMovimentoCaixaidconta_destino: TIntegerField;
    qryCsMovimentoCaixaentrada: TFloatField;
    qryCsMovimentoCaixasaida: TFloatField;
    qryCsMovimentoCaixafixo: TBooleanField;
    qryCsMovimentoCaixaidusuario: TIntegerField;
    qryCsMovimentoCaixaidtipo_lancamento: TIntegerField;
    qryCadMovimentoCaixaidmovimento_caixa: TIntegerField;
    qryCadMovimentoCaixacancelado: TBooleanField;
    qryCadMovimentoCaixadata_lancamento: TDateTimeField;
    qryCadMovimentoCaixatipo: TSmallintField;
    qryCadMovimentoCaixahistorico: TStringField;
    qryCadMovimentoCaixaidconta_origem: TIntegerField;
    qryCadMovimentoCaixaidconta_destino: TIntegerField;
    qryCadMovimentoCaixaentrada: TFloatField;
    qryCadMovimentoCaixasaida: TFloatField;
    qryCadMovimentoCaixafixo: TBooleanField;
    qryCadMovimentoCaixaidusuario: TIntegerField;
    qryCadMovimentoCaixaidtipo_lancamento: TIntegerField;
    qryCsContaContabil: TZReadOnlyQuery;
    qryCadContaContabil: TZQuery;
    DSqryCsContaContabil: TDataSource;
    DSqryCadContaContabil: TDataSource;
    qryCsContaContabilidconta_contabil: TIntegerField;
    qryCsContaContabildescricao: TStringField;
    qryCsContaContabilativo: TBooleanField;
    qryCsContaContabildata_cadastro: TDateField;
    qryCsContaContabiltipo: TSmallintField;
    qryCadContaContabilidconta_contabil: TIntegerField;
    qryCadContaContabildescricao: TStringField;
    qryCadContaContabilativo: TBooleanField;
    qryCadContaContabildata_cadastro: TDateField;
    qryCadContaContabiltipo: TSmallintField;
    qryCsContaContabilcalc_nome_tipo: TStringField;
    qryCsMovimentoCaixaidcliente: TIntegerField;
    qryCsMovimentoCaixacalc_nome_cliente: TStringField;
    qryCadMovimentoCaixaidcliente: TIntegerField;
    qryCadMovimentoCaixacalc_nome_cliente: TStringField;
    qryCsMovimentoCaixacalc_nome_tipo: TStringField;
    qryCadMovimentoCaixacalc_nome_tipo: TStringField;
    qryCsMovimentoCaixaobservacao: TMemoField;
    qryCadMovimentoCaixaobservacao: TMemoField;
    ...
    procedure qryCadVendedorAfterInsert(DataSet: TDataSet);
    procedure qryCadVendedorBeforePost(DataSet: TDataSet);
    procedure qryCadUsuarioBeforePost(DataSet: TDataSet);
    procedure qryCadFormaPagamentoBeforeDelete(DataSet: TDataSet);
    procedure qryCadFormaPagamentoBeforePost(DataSet: TDataSet);
    procedure qryCadVendedorBeforeDelete(DataSet: TDataSet);
    procedure qryCadTipoDocumentoBeforeDelete(DataSet: TDataSet);
    procedure qryCadTipoDocumentoBeforePost(DataSet: TDataSet);
    procedure qryCadMovimentoCaixaBeforeDelete(DataSet: TDataSet);
    procedure qryCadContaContabilBeforeDelete(DataSet: TDataSet);
    procedure qryCadMovimentoCaixaBeforePost(DataSet: TDataSet);
    procedure qryCadContaContabilBeforePost(DataSet: TDataSet);
    procedure qryCsContaContabilCalcFields(DataSet: TDataSet);
    procedure qryCsMovimentoCaixaCalcFields(DataSet: TDataSet);
    procedure qryCadMovimentoCaixaCalcFields(DataSet: TDataSet);
...
procedure TBancoDeDados.qryCadContaContabilBeforeDelete(DataSet: TDataSet);
begin
  if (MessageDlg('Deseja Excluir o registro?',mtWarning,[mbYes,mbNo],0) = mrNo) then
    Abort;
end;

procedure TBancoDeDados.qryCadContaContabilBeforePost(DataSet: TDataSet);
begin
  if not (qryCadContaContabildescricao.Value <> '') then
    begin
      MessageDlg('Informe uma Descrição para a Conta Contabil.',mtWarning,[mbOK],0);
      Abort;
    end
  else
    if (qryCadContaContabiltipo.IsNull) then
      begin
        MessageDlg('Informe um Tipo para a Conta Contabil.',mtWarning,[mbOK],0);
        Abort;
      end
end;

procedure TBancoDeDados.qryCadFormaPagamentoBeforeDelete(DataSet: TDataSet);
begin
  if (MessageDlg('Deseja Excluir o registro?',mtWarning,[mbYes,mbNo],0) = mrNo) then
    Abort;
end;

procedure TBancoDeDados.qryCadFormaPagamentoBeforePost(DataSet: TDataSet);
begin
  if not (qryCadFormaPagamentodescricao.Value <> '') then
    begin
      MessageDlg('Informe uma descrição para a Forma de Pagamento.',mtWarning,[mbOK],0);
      Abort;
    end;
end;
...
procedure TBancoDeDados.qryCadMovimentoCaixaBeforeDelete(DataSet: TDataSet);
begin
  if (MessageDlg('Deseja Excluir o registro?',mtWarning,[mbYes,mbNo],0) = mrNo) then
    Abort;
end;

procedure TBancoDeDados.qryCadMovimentoCaixaBeforePost(DataSet: TDataSet);
begin
  if not (qryCadMovimentoCaixahistorico.Value <> '') then
    begin
      MessageDlg('Informe uma Descrição para o Historico do Lançamento de Caixa.',mtWarning,[mbOK],0);
      Abort;
    end;
end;

procedure TBancoDeDados.qryCadMovimentoCaixaCalcFields(DataSet: TDataSet);
begin
  case qryCadMovimentoCaixatipo.Value of
    0: qryCadMovimentoCaixacalc_nome_tipo.Value := 'Vendas';
    1: qryCadMovimentoCaixacalc_nome_tipo.Value := 'Contas a Receber';
    2: qryCadMovimentoCaixacalc_nome_tipo.Value := 'Contas a Pagar';
    3: qryCadMovimentoCaixacalc_nome_tipo.Value := 'Cheques';
  end;
end;
    ...
    if (TipoOperacao = toInsere) then
      begin
        try
          ...
          MessageDlg('Falha ao tentar gravar o numero sequencial.'+#13+
              ' A operação será cancelada.',mtWarning,[mbOK],0);
          Abort;
        end;
      end;
...
procedure TBancoDeDados.qryCadTipoDocumentoBeforeDelete(DataSet: TDataSet);
begin
  if (MessageDlg('Deseja Excluir o registro?',mtWarning,[mbYes,mbNo],0) = mrNo) then
    Abort;
end;

procedure TBancoDeDados.qryCadTipoDocumentoBeforePost(DataSet: TDataSet);
begin
  if not (qryCadTipoDocumentodescricao.Value <> '') then
    begin
      MessageDlg('Informe uma Descrição para o Tipo de Documento.',mtWarning,[mbOK],0);
      Abort;
    end;
end;
...
procedure TBancoDeDados.qryCadUsuarioBeforePost(DataSet: TDataSet);
begin
  if not (qryCadUsuariologin.Value <> '') then
    begin
      MessageDlg('Informe um Login para o Usuario.',mtWarning,[mbOK],0);
      Abort;
    end;
  if not (qryCadUsuariosenha.Value <> '') then
    begin
      MessageDlg('Informe uma Senha para o Usuario.',mtWarning,[mbOK],0);
      Abort;
    end;
end;

procedure TBancoDeDados.qryCadVendedorAfterInsert(DataSet: TDataSet);
begin
   qryCadVendedoridvendedor.Value := GeraSequenciador(qryCsSequenciador, 'cadvendedor', 'idvendedor');
end;

procedure TBancoDeDados.qryCadVendedorBeforeDelete(DataSet: TDataSet);
begin
  if (MessageDlg('Deseja Excluir o registro?',mtWarning,[mbYes,mbNo],0) = mrNo) then
    Abort
  else
    begin
      ProcScripts.Script.Text := 'delete from cadforma_pagamento_vendedor where idvendedor = ' +
        IntToStr(qryCadVendedoridvendedor.Value) + ';';
      ProcScripts.Execute;
    end;
end;

procedure TBancoDeDados.qryCadVendedorBeforePost(DataSet: TDataSet);
begin
  if not (qryCadVendedorlogin.Value <> '') then
    begin
      MessageDlg('Informe um Login para o Vendedor.',mtWarning,[mbOK],0);
      Abort;
    end;
  if not (qryCadVendedorsenha.Value <> '') then
    begin
      MessageDlg('Informe uma Senha para o Vendedor.',mtWarning,[mbOK],0);
      Abort;
    end
  else
    if (qryCadVendedortipo.IsNull) then
      begin
        MessageDlg('Informe um Tipo para o Vendedor.',mtWarning,[mbOK],0);
        Abort;
      end
    else
      if (TipoOperacao = toInsere) then
        begin
          try
            GravaSequenciador(Conexao, 'cadvendedor', 'idvendedor', qryCadVendedoridvendedor.Value);
          except
            MessageDlg('Falha ao tentar gravar o numero sequencial.'+#13+
                ' A operação será cancelada.',mtWarning,[mbOK],0);
            Abort;
...
procedure TBancoDeDados.qryCsContaContabilCalcFields(DataSet: TDataSet);
begin
  case qryCsContaContabiltipo.Value of
    0: qryCsContaContabilcalc_nome_tipo.Value := 'Caixa';
    1: qryCsContaContabilcalc_nome_tipo.Value := 'Banco';
    2: qryCsContaContabilcalc_nome_tipo.Value := 'Despesa';
    3: qryCsContaContabilcalc_nome_tipo.Value := 'Geral';
  end;
end;
...
procedure TBancoDeDados.qryCsMovimentoCaixaCalcFields(DataSet: TDataSet);
begin
  case qryCsMovimentoCaixatipo.Value of
    0: qryCsMovimentoCaixacalc_nome_tipo.Value := 'Vendas';
    1: qryCsMovimentoCaixacalc_nome_tipo.Value := 'Contas a Receber';
    2: qryCsMovimentoCaixacalc_nome_tipo.Value := 'Contas a Pagar';
    3: qryCsMovimentoCaixacalc_nome_tipo.Value := 'Cheques';
  end;
end;
