...
type
  TPrincipalForm = class(TForm)
    ...
    procedure ContaContabil1Click(Sender: TObject);
...
uses ULogin, Base, UCadCliente, UCadGrupo, UCadSubGrupo, UCadFornecedor,
      ...
      UCadModulos, UFuncoes, UCadParametros, UCadVendedor, UCadFormaPagamento,
      UCadTipoDocumento, UCadContaContabil, UCadMovimentoCaixa;
{$R *.dfm}
...
procedure TPrincipalForm.CadastrodeVendedores1Click(Sender: TObject);
begin
  CriaForm(TCadVendedorForm, CadVendedorForm);
end;
...
begin
  CriaForm(TCadClienteForm, CadClienteForm);
end;

procedure TPrincipalForm.ContaContabil1Click(Sender: TObject);
begin
  CriaForm(TCadContaContabilForm, CadContaContabilForm);
end;
...
procedure TPrincipalForm.FormasdePagamento1Click(Sender: TObject);
begin
  CriaForm(TCadFormaPagamentoForm, CadFormaPagamentoForm);
end;
...
procedure TPrincipalForm.iposdeDocumentos1Click(Sender: TObject);
begin
  CriaForm(TCadTipoDocumentoForm, CadTipoDocumentoForm);
end;
...
begin
  CriaForm(TCadMovimentoCaixaForm, CadMovimentoCaixaForm);
end;
