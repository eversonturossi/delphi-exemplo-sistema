      ...
      then begin
            ...
            then begin
                  Try
                   ...
                   if nQuantidade > 0
                   then begin
                        if DM.TEmpresaPERMITIVENDAESTOQUENEG.Value='N'
                        then begin
          ...
          then begin
               ...
               then begin
                    ...
                    do begin
                       ...
                       then begin
                            if not DM.TOrcGradeTemp.Locate('COD_GRADE;COD_PRODUTO',VarArrayOf([DM.TPesqGradeProdCODIGO.Value,DM.TPesqGradeProdCOD_PRODUTO.Value]),[])
                            then DM.TOrcGradeTemp.Append
                            else DM.TOrcGradeTemp.Edit;
                            DM.TOrcGradeTempCOD_PRODUTO.Value:=DM.TPesqGradeProdCOD_PRODUTO.Value;
                            DM.TOrcGradeTempCOD_GRADE.Value:=DM.TPesqGradeProdCODIGO.Value;
                            DM.TOrcGradeTempQTDE.Value:=DM.TOrcGradeTempQTDE.Value+DM.TPesqGradeProdQTDE_SELECIONADA.Value;
                            DM.TOrcGradeTempCOD_COR.Value:=DM.TPesqGradeProdCOD_COR.Value;
                            DM.TOrcGradeTempCOD_TAMANHO.Value:=DM.TPesqGradeProdCOD_TAMANHO.Value;
                    ...
                    DM.TOrcTemp.Edit;
                    DM.TOrcTempQTDE.Value:=nSoma_Qtde;
                    DM.TOrcTemp.Post;
